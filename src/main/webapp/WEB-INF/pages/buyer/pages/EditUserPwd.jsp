            ...
            <div class="row">
                <div class="col-lg-6 col-12" align="center" >
                    <div class="my__account__wrapper"  width: 600px;>
                        <h3 class="account__title">修改密码</h3>
                        <form action="${pageContext.request.contextPath}/public/edituserpwd"  method="post">
                            <div class="account__form">
                                ...
                                <div class="input__box">
                                    <label>请输入密码<span>*</span></label>
                                    <input type="password" id="password" name="password">
                                </div>
                                <div class="input__box">
                                    <label>请再次输入密码<span>*</span></label>
